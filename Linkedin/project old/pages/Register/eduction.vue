...
watchEffect(() => {
  if (inputedu.Endyear == "") {
    ...
    validationerror.Endyear = "The Year range End-year cannot be before the Start-year";
  } else {
    validationerror.Endyear = "";
  }
});
...
async function handlesubmit() {
  ...
  if (                                       //start_month & start_year
    ...
    if (validationrouter.value != true) {
      toast.error("Please accept the Terms and Conditions after submitting the form.", {
        position: "top-center",
        autoClose:1500
      });
    } else {                                //end_month & end_year
      ...
      store.student.Endmonth =  storemonth.month[inputedu.Endmonth - 1];
        ...
        <div class="mb-3">
          <div class="flex">
            ...
            <div class="w-full mb-3">
              ...
              <p class="text-red-600 font-semibold font-serif absolute ps-2 lg:w-[200px]">
