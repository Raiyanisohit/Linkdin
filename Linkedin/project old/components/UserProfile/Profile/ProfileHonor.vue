...
<template>
 ...
 <div class="flex">
          <div  class="flex hover:bg-gray-300 p-2 rounded-full hover:cursor-pointer">
            <p v-if="showfunction" class="w-5" data-bs-toggle="modal" data-bs-target="#honor" @click="close">
              <img
                src="https://cdn-icons-png.flaticon.com/128/748/748113.png"
                alt=""
              />
            </p>
            <p  v-if="!routeparams" class="w-5" data-bs-toggle="modal" data-bs-target="#honor" @click="close">
              <img
                src="https://cdn-icons-png.flaticon.com/128/748/748113.png"
                alt=""
              />
