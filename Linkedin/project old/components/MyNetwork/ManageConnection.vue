...
<template>
    <div >
        ...
        <div  >
            ...
            <div v-if="data1 > 0" data-bs-toggle="modal" 
            data-bs-target="#connectionModal" class="flex hover:cursor-pointer justify-between">
                <div class="flex p-2">
            ...
            <div v-else class="flex justify-between  hover:cursor-pointer ">
                <div class="flex p-2">
                    <img class="w-7 h-8 mt-1" src="https://cdn-icons-png.flaticon.com/128/3394/3394785.png" alt="">
                    <p class="text-[18px] ps-3 pt-2">Connections</p>
                </div>
