...
function handlesubmit() {
  if (inputusername.firstnamee == "") {
    validationerror.firstnameerror = "* Please enter your first name.";
  }
  if (inputusername.lastnamee == "") {
    validationerror.lastnameerror = "* Please enter your last name.";
  }

  if (inputusername.firstnamee != "" && inputusername.lastnamee != "") {
    if (regex.value.test(inputusername.firstnamee) == false) {
      validationerror.firstnameerror = "Please enter a valid first name.";
    } else if (regex.value.test(inputusername.lastnamee) == false) {
      validationerror.lastnameerror = "Please enter a valid last name.";
    } else {
