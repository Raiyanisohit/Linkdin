...
<template>
    ...
    <div class="pt-5 pb-4 ">
          ...
          <!-- <NuxtLink to="/Profile"> -->
            <p @click="router.push('/Profile')" class="text-center hover:cursor-pointer hover:underline pb-1 text-[18px] font-bold"> {{post.Message ?  post.Message.firstName : '' }} {{post.Message ? post.Message.lastName : ''}} </p>
          <!-- </NuxtLink> -->
