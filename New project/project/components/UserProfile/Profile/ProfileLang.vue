...
async function getuserlang() {
  if (route.params.id) {
    ...
    Alluserlanguage.value = userlang.Message;
...
<template>
      ...
      <div class="px-4 flex justify-between py-2">
        ...
        <div class="flex">
          <div class="flex hover:bg-gray-300 p-2 rounded-full">
            <p  v-if="showfunction" class="w-5 " data-bs-toggle="modal" data-bs-target="#lang">
              <img
                src="https://cdn-icons-png.flaticon.com/128/748/748113.png"
                alt=""
              />
            </p>
            <p  v-if="!routeparams" class="w-5 " data-bs-toggle="modal" data-bs-target="#lang">
              <img
                src="https://cdn-icons-png.flaticon.com/128/748/748113.png"
                alt=""
              />
  ...
  <modal id="lang" title="Add Language">
      <form @submit.prevent="addlang">
        ...
        <div v-if="inputlang.trim()" class="py-2 ">
          <button
