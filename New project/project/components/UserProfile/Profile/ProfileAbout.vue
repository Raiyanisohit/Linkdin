        ...
        <div
            ...
            <div class="px-4 flex justify-between py-2">
              ...
              <div  class="flex hover:bg-gray-300 p-2 rounded-full">
                <p v-if="showfunction" class="w-5 " data-bs-toggle="modal" data-bs-target="#about"><img src="https://cdn-icons-png.flaticon.com/128/61/61456.png" alt=""></p>
                <p v-if="!routeparams" class="w-5 " data-bs-toggle="modal" data-bs-target="#about"><img src="https://cdn-icons-png.flaticon.com/128/61/61456.png" alt=""></p>
              </div>
            </div>
            <div class="pl-6 py-2 pb-3 px-4 ">
              <p  class="text-justify ">{{post ? post.userAbout : '' }}</p>
            </div>
            </div>
    </div>
