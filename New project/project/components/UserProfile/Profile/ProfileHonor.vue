...
<template>
 ...
 <div class="flex">
          <div  class="flex hover:bg-gray-300 p-2 rounded-full">
            <p v-if="showfunction" class="w-5" data-bs-toggle="modal" data-bs-target="#honor">
              <img
                src="https://cdn-icons-png.flaticon.com/128/748/748113.png"
                alt=""
              />
            </p>
            <p  v-if="!routeparams" class="w-5" data-bs-toggle="modal" data-bs-target="#honor">
              <img
                src="https://cdn-icons-png.flaticon.com/128/748/748113.png"
                alt=""
              />
...
<modal id="honor" title=" Honor & Award">
    <form @submit.prevent="handlesubmithonor">
          ...
          <hr />
          <div v-if="honor.title " class="py-3 px-2">
            <button
