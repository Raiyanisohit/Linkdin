            ...
            <div class="pl-6  py-2">
                <div >
                    <ul class="flex justify-between" v-for="(m,index) in Alllang" :key="index"  >
                      ...
                      <li class="pe-5"> <p @click="editmodal(m._id)" class="w-5 ms-2" data-bs-toggle="modal" data-bs-target="#skill" ><img src="https://cdn-icons-png.flaticon.com/128/61/61456.png" alt=""></p></li>
                    </ul>
...
<deletmodal id="deletelang" title="Delete  Language?">
 <p class="text-[18px] pb-3">This will delete {{value}}  from all sections of your language.</p> 
